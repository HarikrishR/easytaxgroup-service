...
const businessRegistratioController = require('./controller');
// const JoiValidator = require('./middleware/JoiValidator'); 
const { businessRegistrationSchema } = require('./joiSchema');
...
const upload = multer({ storage: storage }).fields([
    { name: 'primaryDiversLicense', maxCount: 1 },
    { name: 'secondaryDiversLicense', maxCount: 1 }
]);
...
//   JoiValidator.validate(createUsdotApplicationSchema), 
  ...
  businessRegistratioController.createBusinessRegistrationApplication 
);
